...
SELECT tr.team_post_id
  ...
  FROM tbl_team_recruit tr
  JOIN tbl_user u ON tr.leader_id = u.user_id
 WHERE tr.created_at BETWEEN '2024-03-01 00:00:00' AND '2024-03-10 23:59:59'
 ORDER BY team_post_id DESC;
...
SELECT tr.team_post_id
 ...
 WHERE a.user_id = (SELECT user_id
                      FROM tbl_user
                     WHERE nickname = 'DataScienceKing')
